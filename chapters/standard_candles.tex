...
\end{equation}
is the modeled and $K$-corrected B-band apparent magnitude at maximum light.  The B-band absolute magnitude $M_B$ records the prototypical maximum luminosity.  The final two terms record the adjustment of the maximum light with parameters $\alpha$ and $\beta$ as the coeffiecients of the light curve shape and color corrections.
