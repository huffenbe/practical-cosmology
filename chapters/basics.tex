...
Writing the FRW metric using the comoving distance $\chi$, rather than $r$, as the radial coordinate, we have an alternate form
\begin{equation}
...
As mentioned, we call $\chi$ the comoving distance or the comoving radial distance.  It is the physical distance today if we were to measure with a ruler to the point where the emission (previously) came from.
