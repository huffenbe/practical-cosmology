...
\end{equation}
Note that for $a=1$, this form shows that the sum of the $\Omega$ parameters is unity,
\begin{equation}
...
\end{equation}
to get $\chi(t)$ or more usefully $\chi(z)$. As we see, this distance--redshift relation measures the expansion history via the integrated $1/a(t)$ or $1/H(z)$.  Comparing Equation~(\ref{eqn:H_in_terms_of_Omega}), you can see that $\chi(z)$ has an amplitude determined by $H_0^{-1}$ and a shape determined by the the $\Omega$ parameters (i.e.\ the composition of the Universe).
