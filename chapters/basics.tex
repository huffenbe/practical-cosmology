...
\end{equation}
All determinations of distance depend on the Hubble constant; it is an enormously important quantity and there is still some few percent disagreement about its value.  The inverse of the Hubble constant can be expressed as a time, about 240 Myrs, or a distance, about 4.2 Gpc.  Sometimes the Hubble constant is compared to reference values to make a new parameters such as
\begin{equation}
